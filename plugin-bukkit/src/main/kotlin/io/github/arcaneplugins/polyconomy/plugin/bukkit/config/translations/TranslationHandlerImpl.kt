...
class TranslationHandlerImpl(
    ...
    val prefix = TranslationImpl(
        this,
        arrayOf("prefix"),
        listOf("&b&lPolyconomy:&7")
    )
    private val commandGenericErrorCommandFailure = TranslationImpl(
        this,
    ...
    val commandBalancetopErrorAlreadySearching = TranslationImpl(
        this,
    ...
    val commandGenericErrorIllformedLocale = TranslationImpl(
        this,
        arrayOf("command", "generic", "error", "illformed-locale"),
        listOf("Illformed locale: ")
    )
    val commandGenericErrorIllformedIdentifier = TranslationImpl(
        this,
    ...
    val commandPaySuccess = TranslationImpl(
        this,
    ...
    val commandPolyconomySubroutineDbCleanupCompleted = TranslationImpl(
        this,
        arrayOf("command", "polyconomy", "subroutine", "db-cleanup", "completed"),
        listOf("%prefix% Database cleanup complete.")
    )
    val commandPolyconomySubroutineH2ServerErrorImplementation = TranslationImpl(
        this,
    ...
    val commandPolyconomySubroutineH2ServerErrorAlreadyRunning = TranslationImpl(
        this,
    ...
    val commandPolyconomySubroutineH2ServerStarted = TranslationImpl(
        this,
    ...
    val commandPolyconomyCurrencyRegisterErrorAlreadyExists = TranslationImpl(
        this,
    ...
    val commandPolyconomyReloadCompleted = TranslationImpl(
        this,
        arrayOf("command", "polyconomy", "reload", "completed"),
        listOf("%prefix% Reloaded successfully.")
    )
    val commandPolyconomyReloadErrorGeneric = TranslationImpl(
        this,
    ...
    val commandPolyconomyResetCompleted = TranslationImpl(
        this,
    ...
    val commandPolyconomyVersionView = TranslationImpl(
        this,
    ...
    val commandPolyconomySetCompleted = TranslationImpl(
        this,
    ...
    val commandPolyconomyWithdrawErrorCantAfford = TranslationImpl(
        this,
    ...
    val commandPolyconomyWithdrawCompleted = TranslationImpl(
        this,
